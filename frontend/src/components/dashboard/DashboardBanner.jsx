    ...
    useEffect(() => {
        const fetchProfile = async () => {
            try {
                ...
                console.error('[DashboardBanner] Error fetching profile:', error);
                    ...
                    <div className="max-w-7xl mx-auto px-4 py-3 sm:py-4 sm:px-6 lg:px-8">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                            ...
                            <div className="flex items-center gap-3 sm:gap-4 w-full sm:w-auto justify-end shrink-0">
                                <Link
                                    to="/profile"
                                    className="px-4 py-2 bg-white text-emerald-600 text-sm font-semibold rounded-lg hover:bg-emerald-50 transition-colors shadow-sm whitespace-nowrap"
                                >
                                    {buttonText}
                                </Link>
                                <button
